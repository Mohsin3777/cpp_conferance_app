    ...
    return  Scaffold(
      ...
      body: Container(
        ...
        child: ListView.builder(
          itemCount:  practiceEventModel!.data!.daySchedule!.length <0 ? 0: practiceEventModel!.data!.daySchedule!.length ,
      //  itemCount: 2,
               ...
               children: [
                 Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                   children: [
                     Text(practiceEventModel!.data!.daySchedule![index].date.toString()),
...
// });
showDialog(context: context, builder: (context)=>_alertDialog(index));
                     }, child: Text('ADD')),
                 ...
                 Container(
                  ...
                  width: 1.sw,
                   child: ListView.builder(
                              itemCount:   practiceEventModel!.data!.daySchedule![index].schedule!.length,
                    itemBuilder: (context,ind){
                    return ListTile(
                      title: Text(practiceEventModel!.data!.daySchedule![index].schedule![ind].time.toString()),
                      subtitle: Text(practiceEventModel!.data!.daySchedule![index].schedule![ind].description.toString()),
                      trailing: IconButton(onPressed: (){

                        practiceEventModel!.data!.daySchedule![index].schedule!.removeAt(ind);
                        setState(() {
